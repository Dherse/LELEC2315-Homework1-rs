...
#define SYSID_QSYS_TIMESTAMP 1612996969
...
/*
 * Macros for device 'counter_pio', class 'altera_avalon_pio'
 * The macros are prefixed with 'COUNTER_PIO_'.
 * The prefix is the slave descriptor.
 */
#define COUNTER_PIO_COMPONENT_TYPE altera_avalon_pio
#define COUNTER_PIO_COMPONENT_NAME counter_pio
#define COUNTER_PIO_BASE 0x40000
#define COUNTER_PIO_SPAN 16
#define COUNTER_PIO_END 0x4000f
#define COUNTER_PIO_BIT_CLEARING_EDGE_REGISTER 0
#define COUNTER_PIO_BIT_MODIFYING_OUTPUT_REGISTER 0
#define COUNTER_PIO_CAPTURE 0
#define COUNTER_PIO_DATA_WIDTH 26
#define COUNTER_PIO_DO_TEST_BENCH_WIRING 0
#define COUNTER_PIO_DRIVEN_SIM_VALUE 0
#define COUNTER_PIO_EDGE_TYPE NONE
#define COUNTER_PIO_FREQ 50000000
#define COUNTER_PIO_HAS_IN 0
#define COUNTER_PIO_HAS_OUT 1
#define COUNTER_PIO_HAS_TRI 0
#define COUNTER_PIO_IRQ_TYPE NONE
#define COUNTER_PIO_RESET_VALUE 0
